    ...
    <div class="ltn__product-slider-area ltn__product-gutter pt-115 pb-90 plr--7">
        <div class="container-fluid">
            ...
            <div class="row ltn__product-slider-item-four-active-full-width slick-arrow-1">
                <?php $Featured = DB::table('homes')->orderBy('created_at', 'desc')->limit(4)->get(); ?>
                @foreach ($Featured as $featured)
                <!-- ltn__product-item -->
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-4 text-center---">
                        <div class="product-img">
                            <a href="{{url('/')}}/olinks-homes/{{$featured->slung}}"><img src="{{env('LANDING')}}/uploads/homes/{{$featured->fb_pixels}}" alt="{{$featured->title}}"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge bg-green">@if($featured->sold == "In Stock") Available @else Sold @endif</li>
                                </ul>
                            </div>
                            <div class="product-img-location-gallery">
                                <div class="product-img-location">
                                    <ul>
                                        <li>
                                            <a href="{{url('/')}}/olinks-homes/{{$featured->slung}}"><i class="flaticon-pin"></i> {{$featured->title}}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="product-img-gallery">
                                    <ul>
                                        <li>
                                            <a href="{{url('/')}}/olinks-homes/{{$featured->slung}}/#photos"><i class="fas fa-camera"></i> <?php echo count($Gallery = DB::table('galleries')->where('home_id',$featured->id)->get()) ?></a>
                                        </li>
                                        <li>
                                            <a href="{{url('/')}}/olinks-homes/{{$featured->slung}}"><i class="fas fa-film"></i> 1</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
